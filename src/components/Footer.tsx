      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="text-xl font-bold">Road Guardian</span>
          </div>
        ...
        <nav className="mb-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-sm font-semibold text-guardian-primary tracking-wider uppercase">Product</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-guardian-primary tracking-wider uppercase">Company</h3>
              <ul className="mt-4 space-y-4">
                <li>
            ...
            <div>
              <h3 className="text-sm font-semibold text-guardian-primary tracking-wider uppercase">Resources</h3>
              <ul className="mt-4 space-y-4">
                <li>
            ...
            <div>
              <h3 className="text-sm font-semibold text-guardian-primary tracking-wider uppercase">Legal</h3>
              <ul className="mt-4 space-y-4">
                <li>
                ...
                <li>
                  <a href="#" className="text-base text-gray-300 hover:text-white">Cookies</a>
                </li>
              </ul>
            </div>
          </div>
        </nav>
        <p className="text-center text-base text-gray-400">&copy; {new Date().getFullYear()} Road Guardian. All rights reserved.</p>
      </div>
    </footer>
  );
};
